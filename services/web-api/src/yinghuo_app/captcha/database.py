...
SQLITE_DATABASE_URL = "sqlite+aiosqlite:///captcha.db"
...
async def add_captcha_to_db(session: AsyncSession, captcha_id: str, captcha_text: str, to_email: str=""):
    new_captcha = GeneratedCaptcha(id=captcha_id, text=captcha_text, to_email=to_email)
