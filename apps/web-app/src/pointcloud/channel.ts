...
//   [jobConfig],
//   () => {
//     if (labelAppStatus.pre_seq !== jobConfig) {
//       if (!_.isEmpty(jobConfig.seq) && !_.isEmpty(jobConfig.stream) && jobConfig.frame > -1) {
//         // 数据发生变化，并且完整
//         commonChannel.pub(commonChannel.Events.SeqDataChanged, {})
//       }
//     }
//     labelAppStatus.pre_seq = { ...jobConfig }
//   },
//   { deep: true }
// )
