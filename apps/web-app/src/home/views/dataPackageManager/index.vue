<template>
    <div>
      ...
      <div class="container">
        <TableCustom :columns="columns" :tableData="tableData" :loading="tableLoading" :total="pager.total" :page="pager.page"
          :viewFunc="handleView" :delFunc="handleDelete" :page-change="changePage" :editFunc="handleEdit"
          :refresh="getData">
          <template #toolbarBtn>
            <el-button  type="primary" @click="visible = true;rowData={};"><Icon icon="lucide:plus-circle" />新增</el-button>
          </template>
...
const searchOpt = ref<FormOptionList[]>([
  ...
  { type: "select", label: "优先级：", prop: "yxj", placeholder: '请输入', opts: [{ label: '高', value: 1},{ label: '低', value: 2}] },
...
const rules = reactive<FormRules>({
  ...
  dataCode: [
    { required: true, trigger: "blur", message: '请输入数据包编码' },
  ...
  sspc: [
    { required: true, trigger: "blur", message: '请输入所属批次' },
