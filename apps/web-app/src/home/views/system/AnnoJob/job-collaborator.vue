  ...
  <div>
    <div class="container">
      <TableCustom :columns="columns" :tableData="tableData" :total="pager.total" :page="pager.page"
        :pageSize="pager.page_size" :viewFunc="handleView" :delFunc="handleDelete" :changePage="changePage"
    ...
    <el-dialog title="编辑标注规范" v-model="formEditVisible" destroy-on-close :close-on-click-modal="false"
      align-center="true" style="width: 80%; height: 100%" @close="handleCloseEditor">
