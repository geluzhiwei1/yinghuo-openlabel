<template>
  <div class="user-profile-content">
    <el-button-group class="user-profile-content__tabs">
    ...
    <div v-show="curTab === 'userpass'" class="user-profile-content__panel">
      <UserPassword></UserPassword>
    </div>

    <div v-show="curTab === 'accountInfo'" class="user-profile-content__panel">
