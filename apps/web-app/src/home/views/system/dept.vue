<template>
    ...
    <el-drawer v-model="editorConf.visible" :size="'50%'">
        ...
        <template #default>
            <VueForm size="small" id="propertyForm" ref="propertyForm" label-width="auto" v-model="editorConf.formData"
            :schema="uiSchema" :formProps="{ labelPosition: 'right', layoutColumn: 1}"
...
function confirmClick() {
    ...
    switch (editorConf.mode) {
        ...
        case 'addTop':
            loading.value = true
            userDeptsApi.create(editorConf.formData).then((res) => {
        ...
        case 'edit':
            loading.value = true
            userDeptsApi.update(editorConf.formData).then((res) => {
