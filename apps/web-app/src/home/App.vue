...
const calcUserViewLayout = () => {
  ...
  // 右侧菜单
  userViewLayout.sidePanel.height_px = userViewLayout.window.height_px - userViewLayout.menuBar.height_px
  // userViewLayout.sidePanel.width_px = userViewLayout.window.width_px - userViewLayout.menuBar.width_px

  // 内容区
  userViewLayout.contentPanel.height_px = userViewLayout.window.height_px - userViewLayout.menuBar.height_px
  userViewLayout.contentPanel.width_px = userViewLayout.window.width_px - userViewLayout.sidePanel.width_px
}
