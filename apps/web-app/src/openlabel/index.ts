...
type BBox = BaseObject & BaseLabel & {
    /**
...
type RBBox = BaseObject & BaseLabel & {
    /**
...
type Poly2d = BaseObject & BaseLabel & {
...
type Mask2dBase64 = BaseObject & BaseLabel & {
    encoding: "base64",
...
type Mask2dFile = BaseObject & BaseLabel & {
    encoding: "file",
    mimeType: string, // "image/png"
...
type Cuboid = BaseObject & BaseLabel & {
...
type Polyline3d = BaseObject & BaseLabel & {
...
type Point2d = BaseObject & BaseLabel & {
    ol_type_: 'Point2d',
    /**
     * x, y
     */
...
type Point3d = BaseObject & BaseLabel & {
    ol_type_: 'Point3d',
    /**
...
type BaseContext = BaseObject & BaseLabel & {
    attributes: CommonAttributes;
...
export type {Polyline3d, BBox3d, Cuboid, BBox, RBBox, Poly2d, Mask2dBase64, Mask2dFile, Point3d, Point2d }
