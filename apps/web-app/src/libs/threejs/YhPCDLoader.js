    ...
    if (PCDheader.data === 'binary_compressed') {
      ...
      for (let i = 0; i < PCDheader.points; i++) {
        ...
        if (offset.rgb !== undefined) {
          ...
          const r =
            dataview.getUint8(PCDheader.points * offset.rgb + PCDheader.size[rgbIndex] * i + 2) /
            255.0
          const g =
            dataview.getUint8(PCDheader.points * offset.rgb + PCDheader.size[rgbIndex] * i + 1) /
            255.0
          const b =
            dataview.getUint8(PCDheader.points * offset.rgb + PCDheader.size[rgbIndex] * i + 0) /
            255.0
