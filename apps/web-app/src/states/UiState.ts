...
const uiState = reactive({
   ...
   * 左侧栏
   */
  export const dataPanel = useStorage('yh-ui-attr-dp', {
    /**
    * 数据面板高度
    */
    panelHeight: 700,
   ...
   * 右侧栏
   */
  const attrPanel = useStorage('yh-ui-attr-pn',{
    layer_index: 0,
    height_px: 0,
    width_px: 300,
    focused: false,
  ...
  export { toolSettingLayer, statusBar, topBar, threeView, canvaPanel, mainPanel, attrPanel, appContainer, uiState, userViewLayout }